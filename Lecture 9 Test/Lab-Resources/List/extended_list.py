...
class IntegerListTests(unittest.TestCase):
    ...
    def test_get_data_returns_list_with_the_element(self):
        integer = IntegerList(4, 5, 6)
    ...
    def test_add_method_add_int_adds_the_element(self):
        ...
        self.assertEqual(5, self.int_list.get_data()[3])
    ...
    def test_get_invalid_inde_raises(self):
        self.assertEqual(3, len(self.int_list.get_data()))
    ...
    def test_insert_element_no_integer_raises(self):
        self.assertEqual(3, len(self.int_list.get_data()))
        with self.assertRaises(ValueError) as ex:
